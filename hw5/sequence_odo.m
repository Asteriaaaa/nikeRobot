...
for n = 1: 500   
delta_rot1_hat = delta_rot1 - normrnd(0,(a1*delta_rot1^2 + a2*delta_trans^2));
delta_trans_hat = delta_trans - normrnd(0,(a3*delta_trans^2 + a4*delta_rot1^2 + a4*delta_rot2^2));
delta_rot2_hat = delta_rot2 - normrnd(0,(a1*delta_rot2^2 + a2*delta_trans^2));
x = trajectory_data(1,n,t-1) + delta_trans_hat * cos(theta + delta_rot1_hat);
y = trajectory_data(2,n,t-1) + delta_trans_hat * sin(theta + delta_rot1_hat);
theta = trajectory_data(3,n,t-1) + delta_rot1_hat + delta_rot2_hat;
