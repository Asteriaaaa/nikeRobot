...
des_x = 10; % x of goal pose
des_y = 10; % y of goal pose
...
%===================================== %
% =========== The main loop ========== 
while(((des_x-x(k-1))^2 + (des_y-y(k-1))^2)^0.5 > 0.01) 
...
function draw_robot() 
xmin=0; % setting the figure limits 
xmax=6; 
ymin=0; 
ymax=6; 
